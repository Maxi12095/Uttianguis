...
!((e, t) => {
  ...
  var E = ((e) => {
    var t,
      ...
      ie = me((e) => !0 === e.disabled && ("form" in e || "label" in e), { dir: "parentNode", next: "legend" })
    try {
        ...
        (e) => {
          ...
          return a !== d && 9 === a.nodeType && a.documentElement
            ? ((d = a),
              ...
              (n.getById = ue(
                (e) => ((h.appendChild(e).id = b), !d.getElementsByName || !d.getElementsByName(b).length),
              )),
              n.getById
                ? ((r.filter.ID = (e) => {
      ...
      ((r = oe.selectors =
        {
          ...
          pseudos: {
            ...
            contains: se(
              (e) => ((e = e.replace(Z, ee)), (t) => (t.textContent || t.innerText || i(t)).indexOf(e) > -1),
            ),
            lang: se(
              (e) => (
            ...
            root: (e) => e === h,
            focus: (e) => e === d.activeElement && (!d.hasFocus || d.hasFocus()) && !!(e.type || e.href || ~e.tabIndex),
            enabled: de(!1),
            disabled: de(!0),
            checked: (e) => {
  ...
  w.each(
    {
      ...
      contents: (e) =>
        N(e, "iframe") ? e.contentDocument : (N(e, "template") && (e = e.content || e), w.merge([], e.childNodes)),
    },
    (e, t) => {
      w.fn[e] = function (n, r) {
      ...
      if (t)
        return (
          (Number.parseFloat(Fe(e, "marginLeft")) ||
            e.getBoundingClientRect().left - se(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) + "px"
        )
    })),
      ...
      propHooks: {
        tabIndex: {
          get: (e) => {
            ...
            return t ? Number.parseInt(t, 10) : gt.test(e.nodeName) || (yt.test(e.nodeName) && e.href) ? 0 : -1
          },
        },
      },
  ...
  w.fn.extend({
    ...
    w.each(["radio", "checkbox"], function () {
      ;(w.valHooks[this] = {
        ...
        h.checkOn || (w.valHooks[this].get = (e) => (null === e.getAttribute("value") ? "on" : e.value))
    }),
  ...
  w.extend({
    ...
    (w.expr.pseudos.visible = (e) => !!(e.offsetWidth || e.offsetHeight || e.getClientRects().length)),
    (w.ajaxSettings.xhr = () => {
      try {
